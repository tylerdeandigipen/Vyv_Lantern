...
public:
	...
	enum TypeEnum { cBehavior, cCollider, cImageBuffer, cLight, cPhysics, cTransform, cSprite, cAnimation, cMirror, cSwitch, cEmitter, cDoor, cLineCollider, cBehaviorDoor };
