...
/*!
\file		fmod.hpp
\author		Leron Wong Tai Zhuo (%), Tan Jia Wen (%), Er Jun Wei (%),
            Derrick Woo Ze Bin (%), Xie Fei (%)

\par		email: l.wong@digipen.edu, c.jiawen@digipen.edu, junwei.er@digipen.edu
                   D.woo@digipen.edu, fei.x@digipen.edu
